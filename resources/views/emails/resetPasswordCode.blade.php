...
<head>
    ...
    <title>Restablecer contraseña Shhask</title>
    <style>
        body {
...
<div class="container">
    <div class="header">
        ...
        <h1>Restablecer contraseña de Shhask</h1>
    </div>

    <p>Gracias por utilizar Shhask. Para completar el restablecimiento de contraseña, por favor introduce el siguiente código en la app:</p>
